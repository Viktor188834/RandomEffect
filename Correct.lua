...
function RandomS()
	...
	if RandomDoing == 4 then
		FirstText.Text = "what are you want?"
		SecondText.Text = "nothing"
		wait(3)
		FirstText.Text=" "
	end
	if RandomDoing == 5 then
	...
	if RandomDoing == 7 then
		FirstText.Text = "Let's chilling!"
		SecondText.Text = "ChillGuy"
		humanoidrotpart = charecter.HumanoidRootPart
		wait(3)
		FirstText.Text=" "
	...
	if RandomDoing == 13 and budetliviletatt == 1 then
		Kick()
		wait(999)
	end
end

wait(math.random(ot, to))
RandomS()
wait(math.random(ot, to))
RandomS()
wait(math.random(ot, to))
